...
public class PanelRegistrarPelicula extends javax.swing.JFrame {
    ...
    labelPreviewImagen.setPreferredSize(new Dimension(200, 300)); // o el tamaño que prefieras
...
private void llenarComboCategorias() {
    ...
    private void limpiarCampos() {
        ...
        rutaImagen = "";
        // Si tienes un preview de imagen, también limpiarlo
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 110, 430, 50));

        n1.setFont(new java.awt.Font("Calibri", 1, 20)); // NOI18N
        n1.setForeground(new java.awt.Color(255, 255, 255));
        n1.setText("NOMBRE: ");
        jPanel1.add(n1, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 270, -1, -1));
        ...
        jPanel1.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 360, -1, 20));

        jLabel5.setFont(new java.awt.Font("Calibri", 1, 20)); // NOI18N
        jLabel5.setForeground(new java.awt.Color(255, 255, 255));
        jLabel5.setText("CATEGORIA:");
        jPanel1.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 490, -1, -1));
        ...
        comboGenero.setFont(new java.awt.Font("Arial Black", 1, 12)); // NOI18N
        comboGenero.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Acción", "Comedia", "Drama", "Terror", "Ci-Ficc" }));
        jPanel1.add(comboGenero, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 540, 200, -1));

        comboCategoria.setFont(new java.awt.Font("Arial Black", 1, 12)); // NOI18N
        ...
        jPanel1.add(comboCategoria, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 490, 200, -1));

        txtsipnopsis.setColumns(20);
        txtsipnopsis.setFont(new java.awt.Font("Arial Black", 1, 12)); // NOI18N
        ...
        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 360, -1, -1));

        txtduracion.setFont(new java.awt.Font("Arial Black", 1, 12)); // NOI18N
        ...
        jPanel1.add(txtduracion, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 312, 230, 30));
        ...
        jPanel1.add(txtnombre, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 262, 230, 30));
        ...
        jPanel1.add(botonGuardarRegistroPelicula, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 630, 320, 47));
        ...
        jPanel1.add(botonCancelarRegistrodePeli, new org.netbeans.lib.awtextra.AbsoluteConstraints(710, 630, 320, 47));
        jPanel1.add(labelPreviewImagen, new org.netbeans.lib.awtextra.AbsoluteConstraints(820, 320, 200, 210));

        labelAgregarImagen.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/labelImagenPelicula.png"))); // NOI18N
        jPanel1.add(labelAgregarImagen, new org.netbeans.lib.awtextra.AbsoluteConstraints(820, 330, 200, 200));
        ...
        jPanel1.add(botonAgregarImagen, new org.netbeans.lib.awtextra.AbsoluteConstraints(820, 280, -1, -1));

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/LOGOIZQUIERDA.jpg"))); // NOI18N
        jPanel1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 0, 1060, 640));
