...
public class MenuAdminBar extends javax.swing.JFrame {
    ...
    private void agregarListeners() {
        ...
        mniHorario.addActionListener(e -> {
            new AsignarHorarios().setVisible(true);//PARA ASIGNAR HORARIO DE LAS FUNCIONES
            this.setVisible(false);
        });
        ...
        mniSalas.addActionListener(e -> {
            new SalasSucursal().setVisible(true);//PARA GESTION DE SALAS
            this.setVisible(false);
        });

        mniTop5.addActionListener(e -> {
            new TopPeliculas().setVisible(true);//PARA TOP 5 PELICULAS
            this.setVisible(false);
        });

        mniMasIngresos.addActionListener(e -> {
            new SucursalConMasIngresos().setVisible(true);//PARA SUCURSAL CON MAYOR INGRESOS
        this.setVisible(false);
        });

        mniPeliculaMasVendida.addActionListener(e -> {
            new PeliculaMasVendida().setVisible(true);//PARA PELICULA MAS VENDIDA
            this.setVisible(false);
        });
